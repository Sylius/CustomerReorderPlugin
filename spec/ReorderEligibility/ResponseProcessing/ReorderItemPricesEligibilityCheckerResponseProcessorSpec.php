...
use Sylius\CustomerReorderPlugin\ReorderEligibility\ResponseProcessing\ReorderItemPricesEligibilityCheckerResponseProcessorInterface;
...
final class ReorderItemPricesEligibilityCheckerResponseProcessorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ReorderItemPricesEligibilityCheckerResponseProcessorInterface::class);
    }
